...
class TrackingNetwork(TrackingNetworkBase):
    ...
    def build_net(self, depth_key, image_key, image_current, intrinsics, prev_rotation, prev_translation):
        ...
        with tf.variable_scope("net_M1", reuse=tf.AUTO_REUSE):
            ...
            motion_inc_prediction1 = motion_block(motion_inputs, weights_regularizer=_weights_regularizer,
                                                  resolution_level=2)
        ...
        with tf.variable_scope("net_M2", reuse=tf.AUTO_REUSE):
            ...
            motion_inc_prediction2 = motion_block(motion_inputs, weights_regularizer=_weights_regularizer,
                                                  resolution_level=1)
        ...
        with tf.variable_scope("net_M3", reuse=tf.AUTO_REUSE):
            ...
            motion_inc_prediction3 = motion_block(motion_inputs, weights_regularizer=_weights_regularizer,
                                                  resolution_level=0)
